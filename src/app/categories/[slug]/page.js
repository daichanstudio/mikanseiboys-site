...
export async function generateMetadata({ params }) {
  return {
    ...
    description: `Learn more about ${params.slug === "all" ? "web development" : params.slug} through our News`,
  };
}
...
const blogs = allBlogs.filter(blog => {
  ...
  return (
    <article className="flex flex-col mt-12 text-dark dark:text-light">
      ...
      <div className="grid grid-cols-1 grid-rows-2 gap-16 px-5 mt-5 sm:grid-cols-2 lg:grid-cols-3 sm:mt-10 md:mt-24 sxl:mt-32 sm:px-10 md:px-24 sxl:px-32">
